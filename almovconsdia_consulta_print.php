...
require_once("include/almovconsdia_consulta_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "almovconsdia_consulta" );
