...
function fillProjectEntites()
{
	...
	$projectEntities[ "q_ctrl_numasientos" ] = array( "url" => "q_ctrl_numasientos", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_numasientos" ] = "q_ctrl_numasientos";
	$projectEntities[ "almovconsdia_egresos" ] = array( "url" => "almovconsdia_egresos", "type" => 1 );
	$projectEntitiesReverse[ "almovconsdia_egresos" ] = "almovconsdia_egresos";
	$projectEntities[ "almovconsdia_consulta" ] = array( "url" => "almovconsdia_consulta", "type" => 1 );
	$projectEntitiesReverse[ "almovconsdia_consulta" ] = "almovconsdia_consulta";
	$projectEntities[ "aldevindiv_sol_vinc_a" ] = array( "url" => "aldevindiv_sol_vinc_a", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_sol_vinc_a" ] = "aldevindiv_sol_vinc_a";
	$projectEntities[ "Dashboard" ] = array( "url" => "dashboard", "type" => 4 );
	$projectEntitiesReverse[ "dashboard" ] = "Dashboard";
	$projectEntities[ "cbs" ] = array( "url" => "cbs", "type" => 0 );
	$projectEntitiesReverse[ "cbs" ] = "cbs";
