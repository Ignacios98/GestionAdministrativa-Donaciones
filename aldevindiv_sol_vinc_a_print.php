...
require_once("include/aldevindiv_sol_vinc_a_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aldevindiv_sol_vinc_a" );
