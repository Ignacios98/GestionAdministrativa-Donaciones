...
require_once("include/almovconsdia_egresos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "almovconsdia_egresos" );
