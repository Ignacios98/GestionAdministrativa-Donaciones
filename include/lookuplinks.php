...
function InitLookupLinks()
{
	...
	$lookupTableLinks = array();
		...
		if( !isset( $lookupTableLinks["q_ctrl_numasientos"] ) ) {
			$lookupTableLinks["q_ctrl_numasientos"] = array();
		}
		if( !isset( $lookupTableLinks["q_ctrl_numasientos"]["alasientos.as_nroasiento"] )) {
			$lookupTableLinks["q_ctrl_numasientos"]["alasientos.as_nroasiento"] = array();
		}
		$lookupTableLinks["q_ctrl_numasientos"]["alasientos.as_nroasiento"]["edit"] = array("table" => "alasientos", "field" => "as_nroasiento", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["tparam_status"]["inv_almacen.ascodalmacen_estado"] )) {
			$lookupTableLinks["tparam_status"]["inv_almacen.ascodalmacen_estado"] = array();
		}
		$lookupTableLinks["tparam_status"]["inv_almacen.ascodalmacen_estado"]["edit"] = array("table" => "inv_almacen", "field" => "ascodalmacen_estado", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["contractor_master"]["gedocumentos_ingresos.doccnit"] )) {
			$lookupTableLinks["contractor_master"]["gedocumentos_ingresos.doccnit"] = array();
		}
		$lookupTableLinks["contractor_master"]["gedocumentos_ingresos.doccnit"]["edit"] = array("table" => "gedocumentos_ingresos", "field" => "doccnit", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["contractor_master"]["gedocumentos_ingresos_consumo.doccnit"] )) {
			$lookupTableLinks["contractor_master"]["gedocumentos_ingresos_consumo.doccnit"] = array();
		}
		$lookupTableLinks["contractor_master"]["gedocumentos_ingresos_consumo.doccnit"]["edit"] = array("table" => "gedocumentos_ingresos_consumo", "field" => "doccnit", "page" => "edit");
		if( !isset( $lookupTableLinks["geclasedocto"] ) ) {
			$lookupTableLinks["geclasedocto"] = array();
		}
		...
		if( !isset( $lookupTableLinks[""]["gedocumentos_egresos.doccnit"] )) {
			$lookupTableLinks[""]["gedocumentos_egresos.doccnit"] = array();
		}
		$lookupTableLinks[""]["gedocumentos_egresos.doccnit"]["edit"] = array("table" => "gedocumentos_egresos", "field" => "doccnit", "page" => "edit");
		if( !isset( $lookupTableLinks["geclasedocto"] ) ) {
			$lookupTableLinks["geclasedocto"] = array();
		}
		...
		if( !isset( $lookupTableLinks["alelemconsumo_consulta"]["almovconsdia_consulta.consumo_id_fk"] )) {
			$lookupTableLinks["alelemconsumo_consulta"]["almovconsdia_consulta.consumo_id_fk"] = array();
		}
		$lookupTableLinks["alelemconsumo_consulta"]["almovconsdia_consulta.consumo_id_fk"]["edit"] = array("table" => "almovconsdia_consulta", "field" => "consumo_id_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["aldevindiv_sol"] ) ) {
			$lookupTableLinks["aldevindiv_sol"] = array();
		}
		if( !isset( $lookupTableLinks["aldevindiv_sol"]["aldevindiv_sol_vinc_a.transact_id_fk"] )) {
			$lookupTableLinks["aldevindiv_sol"]["aldevindiv_sol_vinc_a.transact_id_fk"] = array();
		}
		$lookupTableLinks["aldevindiv_sol"]["aldevindiv_sol_vinc_a.transact_id_fk"]["edit"] = array("table" => "aldevindiv_sol_vinc_a", "field" => "transact_id_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["q_global_enservicio"] ) ) {
			$lookupTableLinks["q_global_enservicio"] = array();
		}
		if( !isset( $lookupTableLinks["q_global_enservicio"]["aldevindiv_sol_vinc_a.aldevindiv_id_fk"] )) {
			$lookupTableLinks["q_global_enservicio"]["aldevindiv_sol_vinc_a.aldevindiv_id_fk"] = array();
		}
		$lookupTableLinks["q_global_enservicio"]["aldevindiv_sol_vinc_a.aldevindiv_id_fk"]["edit"] = array("table" => "aldevindiv_sol_vinc_a", "field" => "aldevindiv_id_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["aldevindiv_sol_estados_vinc"] ) ) {
			$lookupTableLinks["aldevindiv_sol_estados_vinc"] = array();
		}
		if( !isset( $lookupTableLinks["aldevindiv_sol_estados_vinc"]["aldevindiv_sol_vinc_a.transactvinc_status"] )) {
			$lookupTableLinks["aldevindiv_sol_estados_vinc"]["aldevindiv_sol_vinc_a.transactvinc_status"] = array();
		}
		$lookupTableLinks["aldevindiv_sol_estados_vinc"]["aldevindiv_sol_vinc_a.transactvinc_status"]["edit"] = array("table" => "aldevindiv_sol_vinc_a", "field" => "transactvinc_status", "page" => "edit");
		if( !isset( $lookupTableLinks["contractor_type"] ) ) {
			$lookupTableLinks["contractor_type"] = array();
		}
		if( !isset( $lookupTableLinks["contractor_type"]["contractor_master.contractor_type"] )) {
