...
if( $pages[PAGE_EDIT] ) {
	...
	$tdataalmovconsdia_ingresos[".afterEditAction"] = 0;
	$tdataalmovconsdia_ingresos[".closePopupAfterEdit"] = 1;
	$tdataalmovconsdia_ingresos[".afterEditActionDetTable"] = "Detail tables not found!";
}
...
$tdataalmovconsdia_ingresos[".addPageEvents"] = true;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "almovconsdia";
	$fdata["Label"] = GetFieldLabel("almovconsdia_ingresos","mcd_salddisponible");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataalmovconsdia_ingresos["mcd_salddisponible"] = $fdata;
		$tdataalmovconsdia_ingresos[".searchableFields"][] = "mcd_salddisponible";
//	mcd_tax
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 11;
...
$proto16["m_sql"] = "mcd_cantasignada";
