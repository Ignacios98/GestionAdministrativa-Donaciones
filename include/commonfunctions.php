...
function checkTableName($shortTName )
{
	...
	if ("almovdevdia" == $shortTName )
		return true;
	if ("q_ctrl_numasientos" == $shortTName )
		return true;
	if ("almovconsdia_egresos" == $shortTName )
		return true;
	if ("almovconsdia_consulta" == $shortTName )
		return true;
	if ("aldevindiv_sol_vinc_a" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_numasientos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_numasientos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("almovconsdia_egresos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="almovconsdia_egresos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("almovconsdia_consulta");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="almovconsdia_consulta";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("aldevindiv_sol_vinc_a");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="aldevindiv_sol_vinc_a";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("cbs");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contractor_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="q_ctrl_numasientos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="almovconsdia_egresos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="almovconsdia_consulta" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="aldevindiv_sol_vinc_a" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
