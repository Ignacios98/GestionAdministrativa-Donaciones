...
$tdataalmovdevdia_ingresos_d[".addPageEvents"] = true;
...
$tdataalmovdevdia_ingresos_d[".sqlHead"] = "SELECT almovdevdia_id,  	devolutivo_id_FK,  	doclasedoc_id_fk,  	gefechaactua,  	geusuario,  	legalizado,  	mdd_cantmovto,  	mdd_cantmovto_verifica,  	mdd_tax,  	mdd_valmovto,  	mdd_valunit,  	mddalmacen,  	mddclasedoc,  	mddcodelem,  	mddcuenta,  	mddfechadoc,  	mddnomelem,  	mddnrodoc,  	mddtipoestruc";
...
//Filters settings
	$fdata["filterTotals"] = 0;
		$fdata["filterMultiSelect"] = 0;
		$fdata["filterTotalFields"] = "almovdevdia_id";
		$fdata["filterFormat"] = "Values list";
		$fdata["showCollapsed"] = false;
