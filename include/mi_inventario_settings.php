...
$tdatami_inventario[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatami_inventario[".originalPagesByType"] = $tdatami_inventario[".pagesByType"];
$tdatami_inventario[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatami_inventario[".originalPages"] = $tdatami_inventario[".pages"];
$tdatami_inventario[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
//	aldevindiv_sol_vinc_a
	
	

		$dIndex = 0;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="aldevindiv_sol_vinc_a";
	...
	$detailsParam["dShortTable"] = "aldevindiv_sol_vinc_a";
	$detailsParam["dCaptionTable"] = GetTableCaption("aldevindiv_sol_vinc_a");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();


		
	$detailsTablesData["Mi_inventario"][$dIndex] = $detailsParam;

	
		$detailsTablesData["Mi_inventario"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["Mi_inventario"][$dIndex]["masterKeys"][]="aldevindiv_id";

				$detailsTablesData["Mi_inventario"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["Mi_inventario"][$dIndex]["detailKeys"][]="aldevindiv_id_fk";
//endif
