...
if( $pages[PAGE_EDIT] ) {
	...
	$tdataalasientos[".afterEditAction"] = 0;
	$tdataalasientos[".closePopupAfterEdit"] = 1;
	$tdataalasientos[".afterEditActionDetTable"] = "Detail tables not found!";
}

if( $pages[PAGE_ADD] ) {
$tdataalasientos[".add"] = true;
$tdataalasientos[".afterAddAction"] = 0;
$tdataalasientos[".closePopupAfterAdd"] = 1;
$tdataalasientos[".afterAddActionDetTable"] = "Detail tables not found!";
}
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "q_ctrl_numasientos";
			$edata["autoCompleteFieldsOnEdit"] = 0;
	$edata["autoCompleteFields"] = array();
		$edata["LCType"] = 0;
	...
	$edata["categoryFields"][] = array( "main" => "ascodalmacen", "lookup" => "ascodalmacen" );
...
// Begin Lookup settings
	...
	$edata["DependentLookups"][] = "as_nroasiento";
