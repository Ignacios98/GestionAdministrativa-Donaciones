...
$tdataq_global_enservicio[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdataq_global_enservicio[".originalPagesByType"] = $tdataq_global_enservicio[".pagesByType"];
$tdataq_global_enservicio[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdataq_global_enservicio[".originalPages"] = $tdataq_global_enservicio[".pages"];
$tdataq_global_enservicio[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsq_global_enservicio["Spanish"]["almovinddia_id_fk"] = "Almovinddia Id Fk";
	$fieldToolTipsq_global_enservicio["Spanish"]["almovinddia_id_fk"] = "";
	$placeHoldersq_global_enservicio["Spanish"]["almovinddia_id_fk"] = "";
	$fieldLabelsq_global_enservicio["Spanish"]["di_cuenta"] = "Di Cuenta";
	$fieldToolTipsq_global_enservicio["Spanish"]["di_cuenta"] = "";
	$placeHoldersq_global_enservicio["Spanish"]["di_cuenta"] = "";
	$fieldLabelsq_global_enservicio["Spanish"]["di_codelem"] = "Di Codelem";
	$fieldToolTipsq_global_enservicio["Spanish"]["di_codelem"] = "";
	$placeHoldersq_global_enservicio["Spanish"]["di_codelem"] = "";
	$fieldLabelsq_global_enservicio["Spanish"]["di_almacen"] = "Di Almacen";
	$fieldToolTipsq_global_enservicio["Spanish"]["di_almacen"] = "";
	$placeHoldersq_global_enservicio["Spanish"]["di_almacen"] = "";
	$fieldLabelsq_global_enservicio["Spanish"]["di_funcionario"] = "Di Funcionario";
	$fieldToolTipsq_global_enservicio["Spanish"]["di_funcionario"] = "";
	$placeHoldersq_global_enservicio["Spanish"]["di_funcionario"] = "";
...
$tdataq_global_enservicio[".googleLikeFields"][] = "almovinddia_id_fk";
$tdataq_global_enservicio[".googleLikeFields"][] = "ca_nomcuenta";
$tdataq_global_enservicio[".googleLikeFields"][] = "cod_cta";
$tdataq_global_enservicio[".googleLikeFields"][] = "di_almacen";
$tdataq_global_enservicio[".googleLikeFields"][] = "di_codelem";
$tdataq_global_enservicio[".googleLikeFields"][] = "di_cuenta";
$tdataq_global_enservicio[".googleLikeFields"][] = "di_fechacompra";
$tdataq_global_enservicio[".googleLikeFields"][] = "di_funcionario";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "q_global_enservicio";
	$fdata["Label"] = GetFieldLabel("q_global_enservicio","almovinddia_id_fk");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataq_global_enservicio["almovinddia_id_fk"] = $fdata;
		$tdataq_global_enservicio[".searchableFields"][] = "almovinddia_id_fk";
//	ca_nomcuenta
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "q_global_enservicio";
	$fdata["Label"] = GetFieldLabel("q_global_enservicio","di_almacen");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataq_global_enservicio["di_almacen"] = $fdata;
		$tdataq_global_enservicio[".searchableFields"][] = "di_almacen";
//	di_codelem
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
	...
	$fdata["ownerTable"] = "q_global_enservicio";
	$fdata["Label"] = GetFieldLabel("q_global_enservicio","di_codelem");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataq_global_enservicio["di_codelem"] = $fdata;
		$tdataq_global_enservicio[".searchableFields"][] = "di_codelem";
//	di_cuenta
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 7;
	...
	$fdata["ownerTable"] = "q_global_enservicio";
	$fdata["Label"] = GetFieldLabel("q_global_enservicio","di_cuenta");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdataq_global_enservicio["di_cuenta"] = $fdata;
		$tdataq_global_enservicio[".searchableFields"][] = "di_cuenta";
//	di_fechacompra
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 8;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "q_global_enservicio";
	$fdata["Label"] = GetFieldLabel("q_global_enservicio","di_funcionario");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataq_global_enservicio["di_funcionario"] = $fdata;
		$tdataq_global_enservicio[".searchableFields"][] = "di_funcionario";
//	di_nroplaca
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 10;
...
$proto0["m_strFieldList"] = "aldevindiv_id,  	almovinddia_id_fk,  	ca_nomcuenta,  	cod_cta,  	di_almacen,  	di_codelem,  	di_cuenta,  	di_fechacompra,  	di_funcionario,  	di_nroplaca,  	di_nroplacastma,  	di_nroserie,  	di_ubica,  	di_valorcompra,  	di_valorultmovto,  	ed_nomelemento,  	edmarca,  	edunidad,  	func_dep,  	func_email,  	func_nombres,  	func_tipovinc,  	idusrglobal_fk,  	ma_nommarca,  	mod_trasnporte,  	nicsp_basedepreciable,  	nicsp_codigo_ppe,  	nicsp_costo,  	nicsp_costodesmant,  	nicsp_depreciaacumulada,  	nicsp_depreciamensual,  	nicsp_dias,  	nicsp_fechacorte,  	nicsp_meses,  	nicsp_politicamaterialidad,  	nicsp_valordeterioro,  	nicsp_valorresidual,  	nicsp_vidautil,  	nicsp_vigenciapm,  	nicsp_vnl,  	Observaciones,  	sys_date,  	sys_sts,  	sys_time,  	sys_user,  	upd_date,  	upd_status,  	upd_user,  	verifica_date,  	verifica_status,  	verifica_user,  	VRMEJORA";
...
$proto8["m_sql"] = "almovinddia_id_fk";
...
$proto34["m_sql"] = "di_valorultmovto";
...
$proto111["m_columns"][] = "almovinddia_id_fk";
$proto111["m_columns"][] = "ca_nomcuenta";
$proto111["m_columns"][] = "cod_cta";
$proto111["m_columns"][] = "di_almacen";
$proto111["m_columns"][] = "di_codelem";
$proto111["m_columns"][] = "di_cuenta";
$proto111["m_columns"][] = "di_fechacompra";
$proto111["m_columns"][] = "di_funcionario";
